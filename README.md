<div align="center">
  <img src="logo.png" width="128" alt="RedPanda Launcher" />
  <h1>RedPanda Launcher</h1>

  <p><strong>The modern Minecraft launcher.</strong><br>
  Beautiful. Fast. Intelligent.<br>
  Built for Vanilla, Fabric, Forge, NeoForge and Quilt.</p>

  <p>
    <a href="https://github.com/t1m0nch1k/RedPanda-Launcher/releases/latest"><img src="https://img.shields.io/github/v/release/t1m0nch1k/RedPanda-Launcher?style=for-the-badge&color=D83B01&label=Release" alt="Latest Release"></a>
    <a href="https://github.com/tauri-apps/tauri"><img src="https://img.shields.io/badge/Tauri-FFC131?style=for-the-badge&logo=Tauri&logoColor=white" alt="Tauri"></a>
...
RedPanda is the launcher's companion.  
It celebrates successful launches.  
Helps you discover new mods.  
Guides you through updates.  
Makes the launcher feel alive.

## 📥 Download

- **[📥 Download Setup v0.2.2 (Windows)](https://github.com/t1m0nch1k/RedPanda-Launcher/releases/download/v0.2.2/RedPanda.Launcher_0.2.2_x64-setup.exe)**
...
- [x] Standalone GUI Installer (`RedPanda.Launcher_0.2.2_x64-setup.exe`)
- [ ] Cloud Sync
- [ ] Plugin System
...
- [Tauri v2](https://tauri.app/) - Core framework
- [Rust](https://www.rust-lang.org/) - Backend & performance
- [React](https://react.dev/) - Frontend UI
- [TypeScript](https://www.typescriptlang.org/) - Type safety
- [Tailwind CSS](https://tailwindcss.com/) - Styling
- `lighty-launcher` - Underlying game launcher engine
...
```bash
git clone https://github.com/t1m0nch1k/RedPanda-Launcher.git
