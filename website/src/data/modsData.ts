...
export const TOP_MODS: ModItem[] = [
  {
    ...
    description: "Самый мощный движок оптимизации рендеринга для Minecraft. Увеличивает FPS в 2-4 раза и снижает задержки кадров.",
  ...
  },
  {
    ...
    description: "Рендеринг LOD-чанков (Level of Detail), позволяющий видеть мир на 128-512 чанков без просадки частоты кадров.",
    category: "Графика",
  ...
  },
  {
    ...
    name: "FerriteCore",
    author: "malte0811",
    description: "Снижает потребление оперативной памяти Minecraft на 30-50% за счет умного дедуплицирования моделей.",
    category: "Оптимизация",
    loaders: ["Fabric", "Forge", "NeoForge"],
    downloads: "55M+",
    source: "Both"
