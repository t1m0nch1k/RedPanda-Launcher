      ...
      <main className="flex-1 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 w-full font-mono">
        ...
        <div className="brutalist-card p-6 sm:p-10 space-y-8 text-xs sm:text-sm leading-relaxed">
          <section className="space-y-3">
            ...
            <p className="text-muted">
              На Windows авторизационные токены лаунчера защищаются локально средствами <strong className="text-foreground">Windows DPAPI</strong>, привязанными к профилю пользователя. Резервный совместимый формат использует AES-256-GCM; токены не передаются веб-сайту.
            </p>
          </section>
